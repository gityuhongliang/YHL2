      ...
      const columns = [
            {
              ...
              render:(name)=>{
                if (keyword) {
                  ...
                  let newName = name.replace(reg,'<b style="background-color:yellow" >'+keyword+'</b>')
                ...
                <div className = 'ProductList' >
                   <AdminLayout >
                    ...
                    <Link to = '/product/save'> 
                      <Button className='xz'type="primary">新增商品</Button>
                    </Link>
                    </div>
                    <div className='content'>
                        ...
                        //点击页码时需要携带keyword   把keyword存到store里面再通过映射拿到
                        onChange={(page)=>{
                          if (keyword) {
